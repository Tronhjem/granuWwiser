...
#ifndef GranuWwiserFXParams_H
#define GranuWwiserFXParams_H
...
struct GranuWwiserFXParams
    : public AK::IAkPluginParam
{
    GranuWwiserFXParams();
    GranuWwiserFXParams(const GranuWwiserFXParams& in_rParams);
    ...
    GranuWwiserRTPCParams RTPC;
    GranuWwiserNonRTPCParams NonRTPC;
} AK_ALIGN_DMA;

#endif // GranuWwiserFXParams_H
